...
export default function Header({ setCategory }) {
  ...
  const handleOpenCloseArrowMenu = function () {
    if (!isArrowTouched) {
      ...
      arrowMenu.current.classList.remove(
        "modal-nav__element-submenu_displayed",
      );
  ...
  return (
    <>
      <header className="py-3.5 md:py-0">
        ...
        <div
          className="modal-nav modal-nav_inactive flex flex-col items-center absolute z-20 bg-main h-full w-64 overflow-y-auto"
          ref={burgerMenu}
        >
          <img
            className="logo text-center h-fit pt-8"
            src={Logo}
            width={156}
            alt="Логотип"
          />
          <nav className="w-full mt-12" onClick={(e) => handleMenuClick(e)}>
            <ul className="flex flex-col items-center modal-nav pb-8 ">
              <li className="flex flex-col justify-between modal-nav__element w-9/12">
                <button
                  className="flex items-center justify-between modal-nav__arrow-btn"
                  type="button"
                  onClick={handleOpenCloseArrowMenu}
                >
                  <span>Меню</span>
                  <img
                    className="modal-nav__arrow transition-transform"
                    src={Arrow}
                    width={21}
                ...
                <button
                  className="modal-nav__arrow-btn"
                  type="button"
                  onClick={handleOpenCloseArrowMenu}
                ></button>
              ...
              <li className="header__contacts flex items-center modal-nav__element w-9/12 mt-8">
                ...
                >
                  <path
                    d="M12 0C7.02938 0 3 4.02938 3 9C3 11.1292 3.93825 13.0016 4.97662 14.625L11.388 23.6835C11.5286 23.8822 11.757 24 12 24C12.243 24 12.4714 23.8822 12.612 23.6835L19.0234 14.625C20.0156 13.2893 21 11.1292 21 9C21 4.02938 16.9706 0 12 0ZM12 14.25C9.1005 14.25 6.75 11.8995 6.75 9C6.75 6.1005 9.1005 3.75 12 3.75C14.8995 3.75 17.25 6.1005 17.25 9C17.25 11.8995 14.8995 14.25 12 14.25Z"
                    fill="black"
                  />
                  <path
                    d="M12 4.5C9.51487 4.5 7.5 6.51487 7.5 9C7.5 11.4851 9.51487 13.5 12 13.5C14.4851 13.5 16.5 11.4851 16.5 9C16.5 6.51487 14.4851 4.5 12 4.5ZM12 12.75C9.92887 12.75 8.25 11.0707 8.25 9C8.25 6.92925 9.92887 5.25 12 5.25C14.0711 5.25 15.75 6.92925 15.75 9C15.75 11.0707 14.0711 12.75 12 12.75Z"
                    fill="black"
                  />
                </svg>
              ...
              <li className="header__contacts flex items-center modal-nav__element w-9/12 mt-7">
                ...
                <a href="tel:292022" className="ml-2">
                  +7 (8172) 29-20-22
                </a>
              </li>
            </ul>
        ...
        <div className="top-header flex justify-between items-center md:flex-col md:h-[213px]">
          <div className="the-top-header wrapper hidden md:block w-full text-sm py-2">
            <ul className="flex items-center text-sm">
              ...
              <li className="header__contacts flex items-center w-fit ml-8">
                ...
                <a href="tel:292022" className="w-fit ml-2">
                  +7 (8172) 29-20-22
                </a>
              </li>
          ...
          <div className="flex items-center w-full wrapper md:py-4">
            ...
            <Link to="/" className="md:hidden company__name ml-2.5">
              МногоСуши
            </Link>
