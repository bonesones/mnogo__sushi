...
export default function Promotions () {
    ...
    return (
        <div className="mt-16 mb-16 flex flex-col items-center">
            ...
            <div className="flex flex-col md:flex-row md:justify-between w-full gap-6 mt-12">
                {
                    promotions.map(promotion => (
                        <Promotion key={promotion.id}  promotion={promotion} setPromotions={setPromotions} />
                    ))
                }
            </div>
        </div>
