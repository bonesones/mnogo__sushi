...
export default function Help() {
    ...
    return (
        <>
            ...
            <section className="wrapper mt-20 flex flex-col gap-6  w-[60rem] items-center mx-auto" onClick={e => handleOpenCloseQuestion(e)}>
                <QuestionCard question="Как оформить заказ?" 
