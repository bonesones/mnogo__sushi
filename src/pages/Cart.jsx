    ...
    <div className="wrapper mx-auto mb-28">
      ...
      <div className="mt-20 flex flex-col items-center">
        {!isEmpty(products) ? (
              ...
              <div className="w-full mt-24 flex flex-col">
                ...
                <div className="mt-16 max-w-[32rem] self-center flex flex-col">
                  ...
                  <div className="flex justify-between flex-col sp:flex-row my-8 gap-6 ">
                    ...
                    />
                    <button
                        className="border border-[#F35E62] text-[#F35E62] text-center bg-inherit rounded-lg hover:bg-[#F35E62] hover:text-white font-medium hover:bg-second px-3">
                      Применить
                    </button>
                  </div>
            ...
            <h2 className="font-mdeium text-xl text-center my-20">Ваша корзина пока что пустая</h2>
        )}
      </div>
    </div>
  );
