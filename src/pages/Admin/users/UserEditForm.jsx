...
export default function UserEditForm() {
    ...
    useEffect(() => {
        ...
        const fetchUser = async () => {
            try {
                const response =  await api.get(`/api/user/admin/getone/${userId}`, {
    ...
    const onSubmit = async function(data) {
        ...
        try {
            await api.put(`/api/user/admin/update/${userId}`, {
                ...
                submit_password: data.submit_password || null,
                role: userRole.value,
                phone: data.phone
            }, {
                withCredentials: true
    ...
    return (
        <div className="mt-16 mb-16 flex flex-col items-center">
            ...
            <div className="w-full flex gap-4 mb-12 font-medium">
                <Link to="/admin/users">Пользователи</Link>><span>Редактировать пользователя</span>
            </div>
