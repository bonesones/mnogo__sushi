export default function ProductDetailsWithoutContains({
  active,
  data,
  handleChange,
}) {
  return (
    <article
      className={
        (active ? "" : "hidden ") +
        "w-96 sm:w-120 lg:w-152 content-box h-168 lg:h-140 sm:h-160 product-details bg-main fixed z-20 px-12 sm:px-20 md:px-12 py-7 lg:box-content flex flex-col overflow-y-auto rounded-md"
      }
    >
      ...
      <div className="flex flex-col lg:gap-8 items-center lg:mt-12">
        <div className="flex flex-col items-center lg:gap-8">
          <img
            className="mt-8 h-60 lg:mt-0 sm:w-10/12 md:w-8/12 lg:w-64 lg:h-64"
            src={data.image}
          />
