...
export default function Callbacks() {
    ...
    useEffect(() => {
        if(filterCurrentOption.value === "Все") {
            ...
            setFilteredCallbacks([...callbacks.filter((callback) => callback.status === filterCurrentOption.value)])
        }
        ...
        <div className="mt-16 flex flex-col items-center">
            ...
            <div className="mt-12 mb-12 w-full">
                <div className="flex items-center gap-4 mb-6">
                    ...
                    <Select options={filterOptions} value={filterCurrentOption} onChange={(e) => (handleFilter(e))} className="w-44" />
                </div>
